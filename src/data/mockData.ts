// Questões e flashcards do banco vivem em public/data/{questions,flashcards}/
// (ver src/services/contentService.ts). Este arquivo mantém apenas os casos
// clínicos e o heatmap de estudo mock, que ainda não foram migrados.
